...
<html>
  <head>
	...
	$(function() {
		//给datebox一个默认值
		$('#startTime').datebox("setValue",'2014-08-07');
	...
	function query(){
		...
		datagrid = $("#datagrid").datagrid({
			url : '${pageContext.request.contextPath}/report/dayAnalysis',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
			pageSize : 10,
  ...
  <body>
  	<center><h1 style="height: 70px;line-height: 70px;">分店营业日对比表</h1></center>
